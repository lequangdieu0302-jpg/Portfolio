...
export default function SkillTree() {
  ...
  const skillBranches: SkillBranch[] = [
    ...
    {
      id: "pp",
      title: "Power Platform & App Dev",
      subtitle: "App Dev, Leadership & IT Collaboration",
      icon: Share2,
      ...
      skills: [
        ...
        { name: "App Development", level: "Expert", description: "Build canvas and model-driven applications for operational tracking, mobile portals, and process automation." },
        { name: "App Dev Leadership", level: "Expert", description: "Lead and coordinate cross-functional developer teams to design, build, test, and release business applications." },
        { name: "IT & Tech Collaboration", level: "Master", description: "Bridge the gap between business operations and the IT department, ensuring smooth governance, data security, and API integrations." },
